...
export default function Chat({sessionId, name}) {
    function sendMessage(e) {
        ...
        if(message){
            ...
            // const room = roomInput.value;
            const room = "";
            socket.emit('send-message', name +": "+ message, room);
            div.textContent = message;
    
            document.querySelector("#message-container").append(div);
            socket.emit("guess", sessionId, message);
        }
    }
  return (
    <div className='chat-wrapper'>
        ...
        <form id="form" >
            ...
            <button type="submit" id="send-message-button" className="btn send-btn"onClick={(e)=>sendMessage(e)}>Send</button>
        </form>
        {/* <form>
